...
st.set_page_config(page_title="BizCard: Extracting Business Card Data",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This is an OCR app"""})
st.markdown("<h1 style='text-align: center; color: white;'>BizCard: Extracting Business Card Data with OCR</h1>",
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://unsplash.com/photos/eFRLnTHTvPQ.jpg");
